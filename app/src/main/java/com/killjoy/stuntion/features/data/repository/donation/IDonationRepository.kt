...
interface IDonationRepository {
    ...
    suspend fun postNewDonor(body: DonorBody, donationId: String): Flow<Resource<String>>
    suspend fun fetchDonationDonors(donationId: String): Flow<Resource<List<DonorResponse>>>
}